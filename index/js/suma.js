...
function calculaPorcentajes(numero){
    //porcentajes semna 1
    document.getElementById("semanal").value=((numero*1.25)/100)*5;
    document.getElementById("retiro").value=(((numero*1.25)/100)*5)*10/100;
    document.getElementById("total").value=(((numero*1.25)/100)*5)-((((numero*1.25)/100)*5)*12/100);
        //residuo semana 1
...
//}
    ...
    function sumar(){
        ...
        if(total!=='' && reinv!==''){
            ...
            //porcentaje 2
            document.getElementById("semanal2").value=(suma2*0.0125)*5;
            document.getElementById("retiro2").value=((suma2*0.0125)*5)*0.12;
            document.getElementById("total2").value=((suma2*0.0125)*5)-(((suma2*0.0125)*5)*0.12);
        }
...
document.getElementById("reinv2").focus(); 
        ...
        function sumar3(){
            ...
            //porcentaje 3
            document.getElementById("semanal3").value=(suma4*0.0125)*5;
            document.getElementById("retiro3").value=((suma4*0.0125)*5)*0.12;
            document.getElementById("total3").value=((suma4*0.0125)*5)-(((suma4*0.0125)*5)*0.12);
...
document.getElementById("reinv3").focus(); 
        ...
        function sumar4(){
            ...
            //porcentaje 4
            document.getElementById("semanal4").value=(sumar4*0.0125)*5;
            document.getElementById("retiro4").value=((sumar4*0.0125)*5)*0.12;
            document.getElementById("total4").value=((sumar4*0.0125)*5)-(((sumar4*0.0125)*5)*0.12);
...
document.getElementById("reinv4").focus(); 
        ...
        function sumar5(){
            ...
            //porcentaje 5
            document.getElementById("semanal5").value=(sum5*0.0125)*5;
            document.getElementById("retiro5").value=((sum5*0.0125)*5)*0.12;
            document.getElementById("total5").value=((sum5*0.0125)*5)-(((sum5*0.0125)*5)*0.12);
...
//=======================================segundo mes==================================
        function sem5(){
            ...
            //porcentaje 6
            document.getElementById("semanal6").value=(ivs6*0.0125)*5;
            document.getElementById("retiro6").value=((ivs6*0.0125)*5)*0.12;
            document.getElementById("total6").value=((ivs6*0.0125)*5)-(((ivs6*0.0125)*5)*0.12);
...
document.getElementById("reinv6").focus();   
        ...
        function sem6(){
            ...
            //porcentaje 7
              document.getElementById("semanal7").value=(ivs7*0.0125)*5;
              document.getElementById("retiro7").value=((ivs7*0.0125)*5)*0.12;
             document.getElementById("total7").value=((ivs7*0.0125)*5)-(((ivs7*0.0125)*5)*0.12);
...
document.getElementById("reinv7").focus(); 
        ...
        function sem7(){
            ...
            //porcentaje 8
              document.getElementById("semanal8").value=(ivs8*0.0125)*5;
              document.getElementById("retiro8").value=((ivs8*0.0125)*5)*0.12;
              document.getElementById("total8").value=((ivs8*0.0125)*5)-(((ivs8*0.0125)*5)*0.12);
...
document.getElementById("reinv8").focus(); 
 ...
 //============
        function sem8(){
            ...
            //porcentaje 9
             document.getElementById("semanal9").value=(ivs9*0.0125)*5;
             document.getElementById("retiro9").value=((ivs9*0.0125)*5)*0.12;
             document.getElementById("total9").value=((ivs9*0.0125)*5)-(((ivs9*0.0125)*5)*0.12);
...
//============
        function sem9(){
            ...
            //porcentaje 10
             document.getElementById("semanal10").value=(ivs10*0.0125)*5;
             document.getElementById("retiro10").value=((ivs10*0.0125)*5)*0.12;
             document.getElementById("total10").value=((ivs10*0.0125)*5)-(((ivs10*0.0125)*5)*0.12);
...
//============
        function sem10(){
            ...
            //porcentaje 11
             document.getElementById("semanal11").value=(ivs11*0.0125)*5;
             document.getElementById("retiro11").value=((ivs11*0.0125)*5)*0.12;
             document.getElementById("total11").value=((ivs11*0.0125)*5)-(((ivs11*0.0125)*5)*0.12);
...
//============ semana 
        function sem11(){
            ...
            //porcentaje 12
             document.getElementById("semanal12").value=(ivs12*0.0125)*5;
             document.getElementById("retiro12").value=((ivs12*0.0125)*5)*0.12;
             document.getElementById("total12").value=((ivs12*0.0125)*5)-(((ivs12*0.0125)*5)*0.12);
...
//============ semana 
        function sem12(){
            ...
            //porcentaje 13
             document.getElementById("semanal13").value=(ivs13*0.0125)*5;
             document.getElementById("retiro13").value=((ivs13*0.0125)*5)*0.12;
             document.getElementById("total13").value=((ivs13*0.0125)*5)-(((ivs13*0.0125)*5)*0.12);
...
//============ semana 
        function sem13(){
            ...
            //porcentaje 14
             document.getElementById("semanal14").value=(ivs14*0.0125)*5;
             document.getElementById("retiro14").value=((ivs14*0.0125)*5)*0.12;
             document.getElementById("total14").value=((ivs14*0.0125)*5)-(((ivs14*0.0125)*5)*0.12);
...
//============ semana 
        function sem14(){
            ...
            //porcentaje 15
             document.getElementById("semanal15").value=(ivs15*0.0125)*5;
             document.getElementById("retiro15").value=((ivs15*0.0125)*5)*0.12;
             document.getElementById("total15").value=((ivs15*0.0125)*5)-(((ivs15*0.0125)*5)*0.12);
...
//============ semana 
        function sem15(){
            ...
            //porcentaje 16
             document.getElementById("semanal16").value=(ivs16*0.0125)*5;
             document.getElementById("retiro16").value=((ivs16*0.0125)*5)*0.12;
             document.getElementById("total16").value=((ivs16*0.0125)*5)-(((ivs16*0.0125)*5)*0.12);
