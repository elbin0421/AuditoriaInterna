	...
	<form class="form-horizontal" method="POST" action="guardarrevisados.php" autocomplete="off">
			<img src="img/logo.png" class="avatar" alt="Avatar Image">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="int" step="0.01" class="form-controlg" id="t_gasera" name="t_gasera" placeholder="Total Gasera">
					</div>
				</div>
				<div class="form-group">
					<label for="total" class="col-sm-2 control-label">Total</label>
					<div class="col-sm-10">
						<input type="int" step="0.01" class="total" id="total" name="total" placeholder="Total Semana">
					</div>
				</div>
...
<div class="form-group">
					<label for="t_planta" class="col-sm-2 control-label">Planta</label>
					<div class="col-sm-10">
						<input type="int" step="0.01" class="form-control" id="t_planta" name="t_planta" placeholder="Total Planta" onchange="sumar();">
					</div>
				</div>
				<div class="form-group">
					<label for="t_tienda" class="col-sm-2 control-label">Tienda</label>
					<div class="col-sm-10">
						<input type="int" step="0.01" class="form-control" id="t_tienda" name="t_tienda" placeholder="Total Tienda" onchange="sumar();">
					</div>
				</div>
				<div class="form-group">
					<label for="t_tnuevas" class="col-sm-2 control-label">TNuevas</label>
					<div class="col-sm-10">
						<input type="int" step="0.01" class="form-control" id="t_tnuevas" name="t_tnuevas" placeholder="Total TNuevas" onchange="sumar();">
					</div>
				</div>
				<hr>
				<div class="form-group">
					<label for="total" class="col-sm-2 control-label">Total</label>
					<div class="col-sm-10">
						<input type="int" step="0.01" class="total" id="total" name="total" placeholder="Total Semana" readonly>
					</div>
				</div>
	</body>
</html>