...
<?php
	...
	$sql = "SELECT * FROM revisiones $where";
  ...
  <body> 
     ...
     <div style="height:30px"></div>
	  ...
	  <div id="titulo" class="titulo">
		<h1 class="text-center text-light">Documentos de Gastos Revisados</h1>
        <h2 class="text-center text-light"> <!--<span class="badge badge-warning">--></span></h2>   
	  </div>
    ...
    <div id="body" class="container">
				<div class="row">
						<table class="table-boton">
							<tr>
								<td><a href="nuevorevisado.php" class="btn btn-primary">Nuevo <span class="glyphicon glyphicon-plus"></span></a>
								</td>
							</tr>	
						</table>
                ...
                <div class="col-lg-12">
					...
					<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr>
								...
								<td><?php echo $row['cantidad_doc']; ?></td>
								<td><?php echo $row['total']; ?></td>
								<td><a href="modificarrevisado.php?codigo=<?php echo $row['codigo']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
								<td><a href="#" data-href="eliminarrevisado.php?codigo=<?php echo $row['codigo']; ?>" data-toggle="modal" data-target="#confirm-delete"><span class="glyphicon glyphicon-trash"></span></a></td>
							</tr>
						<?php } ?>
					</tbody>       
                       </table>                  
